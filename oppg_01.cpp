...
itemType create_tree()  {    //  Fra side 41 i l‘reboka:
  itemType x;
  char c;
  Stack stack(50);
...
void preorder_traverse(itemType t)  {
  Stack stack(50);
...
void postorder_traverse(itemType t)  {
  Stack stack(50);
...
void postorder_traverse2(itemType t)  {
  Stack stack(50);
...
void postorder_traverse3(itemType t)  {
  Stack stack(50);
...
void postorder_traverse4(itemType t)  {
  Stack stack(50);
  itemType s = NULL;       //  Peker til siste utskrevne node.
...
int main()  {
  ...
  postorder_traverse3(root);
  cout << "\nTreet traversert POSTORDER (4.metode):   ";
  postorder_traverse4(root);
  cout << "\n\n";
  return 0;
}
